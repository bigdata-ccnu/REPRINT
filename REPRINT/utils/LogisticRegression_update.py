...
def _logistic_regression_path(X, y, y_soft_label, pos_class=None, Cs=10, fit_intercept=True,
    ...
    if multi_class == 'ovr':
        ...
        if solver not in ['sag', 'saga']:
            lbin = LabelBinarizer()
            Y_multi = lbin.fit_transform(y) if y_soft_label is None else y_soft_label
...
def _log_reg_scoring_path(X, y, y_soft_label, train, test, pos_class=None, Cs=10,
    ...
    y_train = y[train]
    y_test = y[test]
    y_train_soft_labels=y_soft_label[train]
    y_test_soft_labels=y_soft_label[test]
    ...
    coefs, Cs, n_iter = _logistic_regression_path(
        X_train, y_train, y_train_soft_labels, Cs=Cs, l1_ratio=l1_ratio,
    ...
    log_reg = LogisticRegression_update(solver=solver, multi_class=multi_class)
...
class LogisticRegression_update(BaseEstimator, LinearClassifierMixin,
                         SparseCoefMixin):
    """
    ...
    def fit(self, X, y, y_soft, sample_weight=None):
        """
        ...
        fold_coefs_ = Parallel(n_jobs=self.n_jobs, verbose=self.verbose,
            ...
            path_func(X, y, y_soft, pos_class=class_, Cs=[C_],
...
class LogisticRegressionCV(LogisticRegression_update, BaseEstimator,
    ...
    def fit(self, X, y, y_soft_label=None, sample_weight=None):
        """Fit the model according to the given training data.
        ...
        for index, (cls, encoded_label) in enumerate(
            ...
            if self.refit:
                ...
                w, _, _ = _logistic_regression_path(
                    X, y, y_soft_label, pos_class=encoded_label, Cs=[C_], solver=solver,
